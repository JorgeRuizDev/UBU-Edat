...
public class Proceso implements Comparable {
	...
	public int compareTo(Object o) {
		Proceso proceso2 = (Proceso) o;

		if(tiempoProceso> proceso2.getTiempoProceso() ){
			return 1;
		} else if (tiempoProceso< proceso2.getTiempoProceso()){
			return -1;
		} else
			return 0;
	}
	 ...
	 * @return si el proceso no tiene unidades restantes de tiemppo a consumir.
	 *
	 */
	public boolean consumeTiempoProceso(int tiempoConsumido) {
		this.tiempoProceso -= tiempoConsumido;

		return tiempoProceso > 0;
	}
